...
int main(int argc, char ** argv) {
    ...
    const auto handle_upload_file = [&res_ok, &res_error](const httplib::Request & req, httplib::Response & res) {
        ...
        if (!req.has_file("file")) {
            res_error(res, format_error_response("No file uploaded (field name: 'file' missing)", ERROR_TYPE_INVALID_REQUEST));
            return;
        }
